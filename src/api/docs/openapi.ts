...
/**
 * Get servers configuration based on environment
 */
function getServers() {
  ...
  const servers = [
    {
      url: baseUrl,
      description: `${nodeEnv === "production" ? "Production" : "Development"} server`,
    },
  ];
  ...
  paths: {
    "/api/v1/workflow": {
      post: {
        ...
        description:
          "Creates a new academic paper generation job and returns a job ID",
    ...
    "/api/v1/workflow/{jobId}/download": {
      get: {
        ...
        description:
          "Downloads the generated Word document for a completed job. The endpoint will first check if the document path is stored in the job result, and if not found, will attempt to construct the path using the same naming convention as the document generator.",
        ...
        responses: {
          "200": {
            description: "Document file successfully streamed",
            content: {
          ...
          "404": {
            description:
              "Job or document file not found. The error message will include details about the attempted paths (original path from result and fallback path).",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
          ...
          "500": {
            description: "Error streaming document file",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/ErrorResponse",
